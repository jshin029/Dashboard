...
var _getPreviousMonthMemoLast = _interopRequireDefault(require("../utils/getPreviousMonthMemoLast"));
...
function (_ref) {
  ...
  function DayPickerRangeController(props) {
    ...
    _this.state = {
      ...
      phrases: (0, _objectSpread6["default"])({}, props.phrases, {
  ...
  _proto.componentWillReceiveProps = function componentWillReceiveProps(nextProps) {
    ...
    if (Object.keys(modifiers).length > 0) {
      this.setState({
        visibleDays: (0, _objectSpread6["default"])({}, visibleDays, modifiers)
      });
    }
    ...
    if (didFocusChange || phrases !== prevPhrases) {
      ...
      this.setState({
        phrases: (0, _objectSpread6["default"])({}, phrases, {
          chooseAvailableDate: chooseAvailableDate
        })
      });
    }
  ...
  _proto.onPrevMonthClick = function onPrevMonthClick() {
    ...
    this.setState({
      ...
      visibleDays: (0, _objectSpread6["default"])({}, newVisibleDays, this.getModifiers(prevMonthVisibleDays))
    }, function () {
  ...
  _proto.onNextMonthClick = function onNextMonthClick() {
    ...
    this.setState({
      ...
      disablePrev: this.shouldDisableMonthNavigation(minDate, newCurrentMonth),
      disableNext: this.shouldDisableMonthNavigation(maxDate, newCurrentMonth),
      visibleDays: (0, _objectSpread6["default"])({}, newVisibleDays, this.getModifiers(nextMonthVisibleDays))
    }, function () {
  ...
  _proto.onMultiplyScrollableMonths = function onMultiplyScrollableMonths() {
    ...
    this.setState({
      visibleDays: (0, _objectSpread6["default"])({}, visibleDays, this.getModifiers(newVisibleDays))
    });
  };
  ...
  _proto.addModifier = function addModifier(updatedDays, day, modifier) {
    ...
    var updatedDaysAfterAddition = (0, _objectSpread6["default"])({}, updatedDays);
    ...
    if (enableOutsideDays) {
      ...
      updatedDaysAfterAddition = monthsToUpdate.reduce(function (acc, monthIso) {
        ...
        if (!month[iso] || !month[iso].has(modifier)) {
          ...
          acc[monthIso] = (0, _objectSpread6["default"])({}, month, (0, _defineProperty2["default"])({}, iso, modifiers));
        }
      ...
      if (!month[iso] || !month[iso].has(modifier)) {
        var modifiers = new Set(month[iso]);
        modifiers.add(modifier);
        updatedDaysAfterAddition[monthIso] = (0, _objectSpread6["default"])({}, month, (0, _defineProperty2["default"])({}, iso, modifiers));
      }
    }
  ...
  _proto.deleteModifier = function deleteModifier(updatedDays, day, modifier) {
    ...
    var iso = (0, _toISODateString["default"])(day);
    var updatedDaysAfterDeletion = (0, _objectSpread6["default"])({}, updatedDays);
    ...
    if (enableOutsideDays) {
      ...
      if (month[iso] && month[iso].has(modifier)) {
        var modifiers = new Set(month[iso]);
        modifiers["delete"](modifier);
        updatedDaysAfterDeletion[monthIso] = (0, _objectSpread6["default"])({}, month, (0, _defineProperty2["default"])({}, iso, modifiers));
      }
    }
