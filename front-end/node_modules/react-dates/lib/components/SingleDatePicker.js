...
var propTypes = process.env.NODE_ENV !== "production" ? (0, _airbnbPropTypes.forbidExtraProps)((0, _objectSpread2["default"])({}, _reactWithStyles.withStylesPropTypes, _SingleDatePickerShape["default"])) : {};
var defaultProps = {
...
function (_ref) {
  ...
  _proto.responsivizePickerPosition = function responsivizePickerPosition() {
    ...
    if (!withPortal && !withFullScreenPortal) {
      ...
      this.setState({
        dayPickerContainerStyles: (0, _objectSpread2["default"])({}, (0, _getResponsiveContainerStyles["default"])(anchorDirection, currentOffset, containerEdge, horizontalMargin), appendToBody && (0, _getDetachedContainerStyles["default"])(openDirection, anchorDirection, this.container))
      });
    }
  };
